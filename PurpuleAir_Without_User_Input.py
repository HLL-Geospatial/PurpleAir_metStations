...
sensors_list = ['149972', '127439', '83627']
names_for_filePath = ["Crow-Agency", "Hardin", "Big-Horn-river"]
...
for i, sensor_num in enumerate(sensors_list):
    ...
    # Make the API call with user-defined start and end date parameters
    payload = {
        'fields': 'humidity_a, humidity_b, temperature_a, temperature_b, pressure_a, pressure_b, voc_a, voc_b, pm1.0_atm, pm2.5_atm, pm10.0_atm',
        'start': start_date,
        'end': end_date
    }
